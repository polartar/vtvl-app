  ...
  const carouselItems = [
    ...
    },
    {
      title: [
        "Create multiple ",
        // eslint-disable-next-line react/jsx-key
        <strong>vesting smart contracts</strong>,
        ...
        subLabel={
          wallet.subLabel ? (
            <Chip
              ...
              color="primary"
              rounded={true}
              label={wallet.subLabel as string}
            />
          ) : (
            ""
          )
      ...
      <Signing>
        ...
        <WalletContainer>
          ...
          <div className="my-5 text-xs text-neutral-600 font-medium">
            ...
            <a
              className="font-bold text-primary-900 no-underline"
              href="#"
              onClick={() => {}}
            >
              Suggest Wallet
