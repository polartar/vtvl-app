  ...
  return (
    <div className="w-full">
      <div className="w-full flex items-center gap-4">
        <div className="flex-grow flex items-center gap-2 px-5 py-2 bg-white border border-[#d0d5dd] rounded-lg">
      ...
      <div className="mt-5 w-full">
        <div className="inline-flex border border-[#d0d5dd] rounded-lg text-xs text-[#1d2939] font-medium overflow-hidden">
          <div
